...
namespace TRAT
{
    public static class PageExtensionMethods1
    {
        public static Control FindControlRecursive1(this Control ctrl, string controlID)
        {
            ...
            else
            {
                ...
                {
                    Control lookFor = FindControlRecursive1(child, controlID);
    ...
    public partial class MasterLogTime : System.Web.UI.Page
    {
        ...
        void bindTimesheet(string ID)
        {
            try
            {
                ...
                dt = dh.sp_GET_Timesheet_Data(date.ToString("dd-MMM-yyyy"), ddlEmpList.SelectedValue).Tables[0];
                //dt = dh.sp_GET_Timesheet_Data(date.ToString("dd-MMM-yyyy"), "riddhishah@deloitte.com").Tables[0];
            ...
            try
            {
                ...
                foreach (GridViewRow row in gvMain.Rows)
                {
                    ...
                    for (int j = 1; j < gvMain.Columns.Count; j++)
                    {
                        ...
                        row1[1] = ddlEmpList.SelectedValue;
        ...
        public void InsertTimesheetData(DataTable dt)
        {
            try
            {
                ...
                handler.TimeSheetData_INSERT(dt, "1", CommonFunctions.GetUser(), out message);
