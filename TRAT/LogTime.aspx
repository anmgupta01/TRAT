<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LogTime.aspx.cs" Inherits="TRAT.LogTime" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="formSection" runat="server">
    <form runat="server">
    <asp:HiddenField runat="server" ID="hidSAPCode"/>
            ...
            <asp:GridView ID="gvMain" runat="server" CssClass="table" GridLines="None" AutoGenerateColumns="false" ShowFooter="true" DataKeyNames="PID">
                <Columns>
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <div class="col-xs-12" style="display:flex;padding:0px;">
                                <asp:TextBox runat="server" ID="d1" type="number" class="form-control" onchange="Footer();" Text='<%# Eval("d1") %>' min="0" max="24" step="0.01" value='<%# Eval("d1") %>' Enabled='<%# (Convert.ToBoolean(Eval("D1Flag").ToString()))  %>' />
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <div class="col-xs-12" style="display:flex;padding:0px">
                                ...
                                <asp:TextBox runat="server" ID="d2" class="form-control" type="number" onchange="Footer();" Text='<%# Eval("d2") %>' min="0" max="24" step="0.01" value='<%# Eval("d2") %>' Enabled='<%# (Convert.ToBoolean(Eval("D2Flag").ToString()))  %>' />
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <div class="col-xs-12" style="display:flex;padding:0px">
                                ...
                                <asp:TextBox runat="server" ID="d3" class="form-control" type="number" onchange="Footer();" Text='<%# Eval("d3") %>' min="0" max="24" step="0.01" value='<%# Eval("d3") %>' Enabled='<%# (Convert.ToBoolean(Eval("D3Flag").ToString()))  %>' />
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <div class="col-xs-12" style="display:flex;padding:0px;">
                                ...
                                <asp:TextBox runat="server" ID="d4" class="form-control" type="number" onchange="Footer();" Text='<%# Eval("d4") %>' min="0" max="24" step="0.01" value='<%# Eval("d4") %>' Enabled='<%# (Convert.ToBoolean(Eval("D4Flag").ToString()))  %>' />
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <div class="col-xs-12" style="display:flex;padding:0px;">
                                ...
                                <asp:TextBox runat="server" ID="d5" class="form-control" type="number" onchange="Footer();" Text='<%# Eval("d5") %>' min="0" max="24" step="0.01" value='<%# Eval("d5") %>' Enabled='<%# (Convert.ToBoolean(Eval("D5Flag").ToString()))  %>' />
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <div class="col-xs-12" style="display:flex;padding:0px;">
                                ...
                                <asp:TextBox runat="server" ID="d6" class="form-control" type="number" onchange="Footer();" Text='<%# Eval("d6") %>' min="0" max="24" step="0.01" value='<%# Eval("d6") %>' Enabled='<%# (Convert.ToBoolean(Eval("D6Flag").ToString()))  %>' />
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <div class="col-xs-12" style="display:flex;padding:0px;">
                                ...
                                <asp:TextBox runat="server" ID="d7" class="form-control" type="number" onchange="Footer();" Text='<%# Eval("d7") %>' min="0" max="24" step="0.01" value='<%# Eval("d7") %>' Enabled='<%# (Convert.ToBoolean(Eval("D7Flag").ToString()))  %>' />
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn" data-dismiss="modal" onclick="javascript: return AddComment();">Add</button>
