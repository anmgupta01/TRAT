<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MasterSubSector.aspx.cs" Inherits="TRAT.MasterSubSector" %>
...
<asp:Content ID="formSection" ContentPlaceHolderID="formSection" runat="server">
    <form runat="server">
        ...
        <div class="row">&nbsp;</div>
            ...
            <div class="col-lg-2">
                <asp:DropDownList runat="server" AutoPostBack="true" ID="drpSector" OnSelectedIndexChanged="drpSector_SelectedIndexChanged"></asp:DropDownList>
            </div>
        ...
        <div class="row">&nbsp;</div>
            ...
            <div class="row" runat="server" id="divAddSect" >
                <div class="col-lg-2">Sub-Sector Name:</div>
                <div class="col-lg-6">
                    <asp:TextBox runat="server" ID="txtSectorName" Width="300px"></asp:TextBox>
                    <asp:Button runat="server" ID="btnAdd" Text="Add New Sub-Sector" OnClick="btnAdd_Click" />
                </div>
            </div><br /><br />
        </div>
    </form>
