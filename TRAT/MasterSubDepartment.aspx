<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MasterSubDepartment.aspx.cs" Inherits="TRAT.MasterSubDepartment" %>
    ...
    <form runat="server">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <asp:DropDownList runat="server" CssClass="form-control" AutoPostBack="true" ID="drpDepartment" OnSelectedIndexChanged="drpDepartment_SelectedIndexChanged"></asp:DropDownList>
                </div>
                <asp:RequiredFieldValidator ID="valSector" runat="server" Display="None"
                    ControlToValidate="drpDepartment" InitialValue="-1" ErrorMessage="Sector is required"
                    ForeColor="Red"
            ...
            <div class="row" runat="server" id="divAddSect">
                <div class="col-lg-2">Sub-Department Name:</div>
                <div class="col-lg-4">
                    <asp:TextBox runat="server" Placeholder="Enter Sub Department Name" CssClass="form-control" ID="txtSubDepartmentName"></asp:TextBox>
                </div>
                <div class="col-lg-2">
                    <asp:Button runat="server" ID="btnAdd" Text="Add New Sub-Department" OnClick="btnAdd_Click" />
