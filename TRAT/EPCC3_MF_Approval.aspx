<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EPCC3_MF_Approval.aspx.cs" Inherits="TRAT.EPCC3_MF_Approval" %>
                ...
                <asp:GridView ID="gvWorkOrder" runat="server" CssClass="table" AutoGenerateColumns="false" GridLines="None" DataKeyNames="Id" OnRowCommand="gvWorkOrder_RowCommand">
                    <Columns>                        
                       ...
                       <asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
                                <asp:LinkButton ID="btnApprove" runat="server" Text="Approve" Enabled=' <%# Eval("EngagementManagerApproval").ToString() == "False" ? true : String.IsNullOrEmpty(Eval("EngagementManagerApproval").ToString())?true:false %>' CommandArgument='<%#Eval("Id")%>' CommandName="Approve" />
                            </ItemTemplate>
                        </asp:TemplateField>  
                         <asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
