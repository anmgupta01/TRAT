    ...
    public partial class MasterDepartment : System.Web.UI.Page
    {
        ...
        void bindGrid()
        {
            try
            {
                ...
                gvProjects.DataSource = ds.Tables[10];
                gvProjects.DataBind();
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    lblAlert.InnerText = dbh.MasterDepartment("0", txtSectorName.Text, "0", CommonFunctions.GetUser());
                    alert.Visible = true;
                    bindGrid();
                    gvProjects.EditIndex = -1;
                ...
                {
                    lblAlert.InnerText = "Enter the name of the department!";
                    alert.Visible = true;
                }
            }
            catch (Exception ex)
        ...
        protected void gvProjects_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                lblAlert.InnerText = dbh.MasterDepartment(e.Keys["Id"].ToString(), e.Values["Name"].ToString(), "1", CommonFunctions.GetUser());
                alert.Visible = true;
                gvProjects.EditIndex = -1;
                bindGrid();
            }
        ...
        protected void gvProjects_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                lblAlert.InnerText = dbh.MasterDepartment(e.Keys["Id"].ToString(), newval, "0", CommonFunctions.GetUser());
                alert.Visible = true;
                gvProjects.EditIndex = -1;
                bindGrid();
            }
