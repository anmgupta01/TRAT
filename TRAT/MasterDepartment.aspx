<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MasterDepartment.aspx.cs" Inherits="TRAT.MasterDepartment" %>
        ...
        <div class="container">
                        ...
                        <asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
                                <asp:LinkButton ID="DeleteButton" runat="server" Text="Disable" CommandArgument='<%#Eval("Id")%>' 
                                    CommandName="Delete" OnClientClick="return confirm('Are you sure you want to delete this department?');" />
                            </ItemTemplate>                            
                        </asp:TemplateField>                                                
                    </Columns>                    
                    <EmptyDataTemplate>                        
            ...
            <div class="row" runat="server" id="divAddSect" >
                ...
                <div class="col-lg-6">
                    ...
                    <asp:Button runat="server" ID="btnAdd" Text="Add New Department" OnClick="btnAdd_Click" />
                </div>
            </div><br /><br />
        </div>
    </form>
